			...
			<div class="header-content d-flex justify-content-between align-items-center">
				<div class="header-left-content d-flex">
					...
					<form action="{{ site_url('search') }}" method="post" class="search-bar d-flex">
						<img src="{{ asset_url('images/icon/search-normal.svg') }}" alt="Katalog Ara">
						<input type="search" name="search" placeholder="Katalog Ara" class="form-control" aria-label="Ara">
					</form>
						...
						<div class="search-overlay search-popup">
							<div class="search-box">
								<form action="{{ site_url('search') }}" method="post" class="search-form">
									<input type="text" name="search" placeholder="Katalog Ara" class="search-input">
					...
					@else
						...
						<div class="header-right-option template-option">
							<a href="{{ site_url('panel/login') }}">
								<img src="{{ asset_url('images/icon/user-octagon.svg') }}" alt="Ayarlar">
							</a>
						</div>
